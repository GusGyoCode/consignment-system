<template>
  <section class="w-full md:w-10/12 lg:w-9/12 xl:w-7/12 px-4 mx-auto flex justify-center items-center">
    <form class="border-solid border border-gray-300 p-4 rounded-2xl w-full" @submit.prevent="save()">
...
export default {
  ...
  methods: {
    save () {
      this.progress = true
      axios
        .post(this.url + 'api/save', this.consignment)
        .then((response) => {
...
<style>
h2 .nuxt-link-exact-active.create::before {
  content: "Crear Remesa";
}
</style>
